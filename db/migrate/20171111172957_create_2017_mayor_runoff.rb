class Create2017MayorRunoff < ActiveRecord::Migration
...
# }
  ...
  def up
    clone_event_id = 43 # 2014 mayor runoff
    clone_ind_event_id = 43 # 2014 mayor runoff
    ...
    Event.transaction do
      ...
      if event.present?
        ...
        event.event_translations.each do |trans|
          if trans.locale == 'en'
            trans.name = '2017 Self-Governing City Mayor Runoff Election'
            trans.name_abbrv = '2017 Self-Governing City Mayor Runoff'
            trans.description = 'The results of the Novermber 12, 2017 runoff election for Self-Governing City Mayor. For 1 mayor race, no candidate received more than 50% of the vote on October 21, 2017, so a runoff was held. Mayors of self-governing cities are elected for four year terms.'
          else
            trans.name = '2017 წლის თვითმმართველი ქალაქის მერის არჩევნები მეორე ტური '
            trans.name_abbrv = '2017 წლის თვითმმართველი ქალაქის მერის მეორე ტური '
            trans.description = '2017 წლის 11 ნოემბერის თვითმმართველი ქალაქის მერი არჩევნების მეორე ტურის შედეგები. 2017 წლის 21 ოქტომბერის, 1 ქალაქში ხმების 50%ზე მეტის მიღება ვერც ერთმა კანდიდატმა შეძლო, რის გამოც მეორე ტური დაინიშნა. თვითმმართველი თემის მერები არჩეული არიან 4 წლის ვადით.'
          end
        end
        event.save
  ...
  def down
    Event.transaction do
      event = Event.includes(:event_translations).where(:event_date => '2017-11-12', event_translations: {name: '2017 Self-Governing City Mayor Runoff Election'}).first
      if event.present?
