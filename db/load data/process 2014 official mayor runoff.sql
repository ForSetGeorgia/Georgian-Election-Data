...
truncate table `2014 election mayor runoff - raw`;

# load data from the csv file
LOAD DATA INFILE '/var/www/data/2014_official_mayor_runoff.csv'
INTO TABLE `2014 election mayor runoff - raw`
...
update `2014 election mayor runoff - raw` as t, regions_districts as rd
set t.region = rd.region,t.district_name = rd.district_name
where t.district_id = rd.district_id;

# add valid votes
update `2014 election mayor runoff - raw`
...
'Georgian Dream'
union
select * from `2014 election mayor runoff - csv` where common_id != '' && common_name != ''
INTO OUTFILE '/var/www/data/upload_2014_official_mayor_runoff.csv'
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\n';
