...
def oct
  table_raw = '2017 oct voters list - raw'
  table_csv = '2017 oct voters list - csv'
  input_csv = '2017_oct_voters_list.csv'
  output_csv = 'upload_2017_oct_voters_list.csv'
