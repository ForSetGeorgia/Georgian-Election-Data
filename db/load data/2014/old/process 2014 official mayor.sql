...
truncate table `2014 election mayor - raw`;

# load data from the csv file
LOAD DATA INFILE '/var/www/data/2014_official_mayor.csv'
INTO TABLE `2014 election mayor - raw`
...
'Georgian Dream'
union
select * from `2014 election mayor - csv` where common_id != '' && common_name != ''
INTO OUTFILE '/var/www/data/upload_2014_official_mayor.csv'
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\n';
