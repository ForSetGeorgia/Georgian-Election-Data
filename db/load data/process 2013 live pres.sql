...
truncate table `2013 election pres - staging`;
truncate table `2013 election pres - raw`;

# load data from the csv file
LOAD DATA LOCAL INFILE '/var/www/data/2013_live_pres.csv'
INTO TABLE `2013 election pres - staging`
