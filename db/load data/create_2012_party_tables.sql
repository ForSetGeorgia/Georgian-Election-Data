...
`2012 election parl party list - country`.`avg precinct difference more ballots than votes` AS `More Ballots Than Votes (Average)`, 
...
`2012 election parl party list - country`.`avg precinct difference more votes than ballots` AS `More Votes than Ballots (Average)`, 
...
`2012 election parl party list - region`.`avg precinct difference more ballots than votes` AS `More Ballots Than Votes (Average)`, 
NULL AS `More Ballots Than Votes (#)`,
...
`2012 election parl party list - region`.`avg precinct difference more votes than ballots` AS `More Votes than Ballots (Average)`, 
NULL AS `More Votes than Ballots (#)`,
NULL AS `Average votes per minute (08:00-12:00)`,
NULL AS `Average votes per minute (12:00-17:00)`,
NULL AS `Average votes per minute (17:00-20:00)`,
...
`2012 election parl party list - districts`.`avg precinct difference more ballots than votes` AS `More Ballots Than Votes (Average)`, 
NULL AS `More Ballots Than Votes (#)`,
...
`2012 election parl party list - districts`.`avg precinct difference more votes than ballots` AS `More Votes than Ballots (Average)`, 
NULL AS `More Votes than Ballots (#)`,
NULL AS `Average votes per minute (08:00-12:00)`,
NULL AS `Average votes per minute (12:00-17:00)`,
NULL AS `Average votes per minute (17:00-20:00)`,
...
`2012 election parl party list - precincts`.`more_ballots_than_votes` AS `More Ballots Than Votes (#)`,
null AS `Precincts with More Votes than Ballots (#)`,
null AS `Precincts with More Votes than Ballots (%)`,
null AS `More Votes than Ballots (Average)`, 
`2012 election parl party list - precincts`.`more_votes_than_ballots` AS `More Votes than Ballots (#)`,
...
`2012 election parl party list - tbilisi district`.`avg precinct difference more ballots than votes` AS `More Ballots Than Votes (Average)`, 
NULL AS `More Ballots Than Votes (#)`,
...
`2012 election parl party list - tbilisi district`.`avg precinct difference more votes than ballots` AS `More Votes than Ballots (Average)`, 
NULL AS `More Votes than Ballots (#)`,
NULL AS `Average votes per minute (08:00-12:00)`,
NULL AS `Average votes per minute (12:00-17:00)`,
NULL AS `Average votes per minute (17:00-20:00)`,
...
null AS `Precincts with More Ballots Than Votes (%)`,
null AS `More Ballots Than Votes (Average)`, 
`2012 election parl party list - tbilisi precincts`.`more_ballots_than_votes` AS `More Ballots Than Votes (#)`,
null AS `Precincts with More Votes than Ballots (#)`,
null AS `Precincts with More Votes than Ballots (%)`,
null AS `More Votes than Ballots (Average)`, 
`2012 election parl party list - tbilisi precincts`.`more_votes_than_ballots` AS `More Votes than Ballots (#)`,
