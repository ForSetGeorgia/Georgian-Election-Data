...
`2012 election parl party list - country`.`total valid ballots cast` AS `Total Turnout (#)`,
`2012 election parl party list - country`.`percent voters voting` AS `Total Turnout (%)`,
...
`2012 election parl party list - country`.`num precincts logic fail` AS `Precincts with Missing Ballots (#)`,
...
`2012 election parl party list - region`.`total valid ballots cast` AS `Total Turnout (#)`,
`2012 election parl party list - region`.`percent voters voting` AS `Total Turnout (%)`,
...
NULL AS `Invalid Ballots (%)`,
`2012 election parl party list - region`.`num precincts logic fail` AS `Precincts with Missing Ballots (#)`,
...
`2012 election parl party list - districts`.`total valid ballots cast` AS `Total Turnout (#)`,
`2012 election parl party list - districts`.`percent voters voting` AS `Total Turnout (%)`,
...
NULL AS `Invalid Ballots (%)`,
`2012 election parl party list - districts`.`num precincts logic fail` AS `Precincts with Missing Ballots (#)`,
...
`2012 election parl party list - precincts`.`total valid ballots cast` AS `Total Turnout (#)`,
`2012 election parl party list - precincts`.`percent voters voting` AS `Total Turnout (%)`,
...
`2012 election parl party list - tbilisi district`.`total valid ballots cast` AS `Total Turnout (#)`,
`2012 election parl party list - tbilisi district`.`percent voters voting` AS `Total Turnout (%)`,
...
NULL AS `Invalid Ballots (%)`,
`2012 election parl party list - tbilisi district`.`num precincts logic fail` AS `Precincts with Missing Ballots (#)`,
...
`2012 election parl party list - tbilisi precincts`.`total valid ballots cast` AS `Total Turnout (#)`,
`2012 election parl party list - tbilisi precincts`.`percent voters voting` AS `Total Turnout (%)`,
NULL AS `Number of Precincts with Invalid Ballots from 0-1%`,
NULL AS `Number of Precincts with Invalid Ballots from 1-3%`,
NULL AS `Number of Precincts with Invalid Ballots from 3-5%`,
NULL AS `Number of Precincts with Invalid Ballots > 5%`,
