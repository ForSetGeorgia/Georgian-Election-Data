...
#gem 'linecache19', '0.5.13', :path => "~/.rvm/gems/ruby-1.9.3-p125@electionmap/gems/linecache19-0.5.13/"
#gem 'ruby-debug-base19', '0.11.26', :path => "~/.rvm/gems/ruby-1.9.3-p125@electionmap/gems/ruby-debug-base19-0.11.26/"
