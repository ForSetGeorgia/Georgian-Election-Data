...
### BEGIN INIT INFO
# Provides:          Election-Map_unicorn_initialization
# Required-Start:    $remote_fs $syslog
# Required-Stop:     $remote_fs $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Election-Map unicorn initialization
...
APP_ROOT=/home/deploy/Election-Map/current # path to application current folder
